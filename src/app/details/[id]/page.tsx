        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-[14px]">
              ...
              Vitae ad eos magnam animi eius, dolorem illum, porro unde ex 
              expedita deserunt perspiciatis, numquam quae impedit eveniet 
              debitis rerum itaque placeat?
            </p>
            <p className="text-gray-500 text-[14px]">20 in stock</p>

            <button
              className="uppercase bg-accent py-4 px-8 rounded-lg text-white
